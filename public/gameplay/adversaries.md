...
To make a judgement about what your adventuring party can handle, calculate the average party Tier. To do this, take each character's Tier, add them together, and divide by the number of characters (rounded up). Then, add the players' [[tokens|Party Level]].
