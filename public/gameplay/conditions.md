...
| Dazed         | A Dazed creature has Disadvantage on Mental Tests and cannot take Reactions.                                                                      |
...
| Distracted    | A creature that applies the Distracted condition to a target is considered Unseen to that target, or can transfer the Unseen condition to an ally within Yonder.                                                                                                                                                                                                                                                                          |
...
| Vulnerable    | Attacks made against a Vulnerable creature are made with Advantage, and Tests made by a Vulnerable creature against damaging effects are made with Disadvantage. A creature can be Mentally, Physically, or Completely Vulnerable, which dictates which Tests are given Advantage and Disadvantage based on what Stress Tracks they target. Creatures may also be Specifically Vulnerable, which triggers the Advantage and Disadvantage  |
