<<<<<<< HEAD:public/gameplay/conditions.md
---
aliases:
  - Minor Conditions
  - Major Conditions
...
| Petrified     | A Petrified creature cannot move or take Actions, Surges, or reactions. Physical Attacks against this creature have Advantage.                    |
...
| Distracted    | A creature that applies Distracted condition to a target is considered Unseen to that target.                                                                                               |
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bleeding (P)  | Suffer 1 Stress in a given Potential (P) at the beginning of each of your turns.                                                                  |
| Dazed         | A Dazed creature has Disadvantage on Spellcasting Tests and cannot take Reactions.                                                                |
| Fortified (X) | A Fortified creature reduces X amount of incoming Mental Stress.                                                                                  |
| Frenzied      | A Frenzied creature is not constrained by the number of turns it can take in one round, though each turn cannot directly follow one of its turns. |
| Invisible     | An Invisible creature cannot be targeted by attacks.                                                                                              |
| Petrified     | A Petrified creature cannot move or take Actions, Surges, or reactions. Physical Attacks against this creature have Advantage.                    |
...
>>>>>>> dev:public/campaigns/conditions.md
