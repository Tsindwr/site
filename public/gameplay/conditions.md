...
| Vulnerable    | Attacks made against a Vulnerable creature are made with Advantage. A creature can be Mentally, Physically, or Completely Vulnerable, which dictates which attacks are given Advantage based on what Stress Tracks they target. |
