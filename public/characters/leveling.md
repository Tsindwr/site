...
Character levels in Sunder are a fluid concept, considering Abilities are purchased using the Experience Market. A character with no levels in a specific [[archetypes|Archetype]] could have just as much adventuring capability as a 5th-level adventurer, as long as they have developed their abilities in a diverse array. However, Archetype leveling is one of the most cost-efficient ways of upgrading a character's [[abilities|Stats]], including the only way to increase their [[damage|Mark]] pool.
...
>Aside from the 1 Milestone granted at the beginning of an adventurer's journey, they also need to choose [[origin|Origin]] features, as well as starting scores in their Potentials. Starting Potential scores are decided by rolling 3D4 and dropping the highest. If all three D4 values result in a 1, the overall Potential value is a 1.
...
>When you choose your first archetype level as a new adventurer, you gain the following additional benefits:
>- Starting Marks determined in [[archetypes|Archetypes]]
>- 1 Domain
>- 2 Skills
>- 1 Heroic Goal
### Character Tiers
